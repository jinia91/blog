...
import kr.co.jiniaslog.admin.application.CreateMockUser
...
class AuthDevResources(
    ...
    @PostMapping("/users")
    fun createUsers(): ResponseEntity<Void> {
        adminUseCases.handle(CreateMockUser.Command())
    ...
    fun login(
        ...
        val mockAccessToken = buildTestUserToken(role)
    ...
    private fun buildTestUserToken(role: Role): String {
